...
const schema = z.object({
  ...
  JWT_ACCESS_SECRET: z
    .string()
    .min(32)
    .default("dev-access-secret-change-me-123456789"),
  JWT_REFRESH_SECRET: z
    .string()
    .min(32)
    .default("dev-refresh-secret-change-me-12345678"),
  ...
  WALKAI_IMAGE_API_KEY: z.string().default(""),
  WALKAI_IMAGE_MODEL: z.string().default("gpt-image-1"),
